...
public class RotateUsingVisionContinuous extends Command implements PIDSource, PIDOutput {
    ...
    public static RotateUsingVisionContinuous rotate;
    
    public static RotateUsingVisionContinuous getInstance() {
    	return rotate == null ? rotate = new RotateUsingVisionContinuous() : rotate;
    }
    
    public RotateUsingVisionContinuous(double timeOut) {
    	this();
