...
public class SynchronousPID {
     ...
     */
    public SynchronousPID setPID(double p, double i, double d) {
        m_P = p;
        m_I = i;
        m_D = d;
        return this;
     ...
     */
    public SynchronousPID setContinuous(boolean continuous) {
     ...
     * the setpoint.
     */
    public SynchronousPID setContinuous() {
     ...
     */
    public SynchronousPID setInputRange(double minimumInput, double maximumInput) {
     ...
     */
    public SynchronousPID setOutputRange(double minimumOutput, double maximumOutput) {
     ...
     */
    public SynchronousPID setSetpoint(double setpoint) {
